...
### sageattention
1、下载[sageattention](https://github.com/woct0rdho/SageAttention/releases)到本地，下载正式版本，且版本要和本地环境保持一致
...
mklink /J "E:\AiPainting\ComfyUI-aki-v2\ComfyUI\models" "E:\AiPainting\modelLibrary"
```
